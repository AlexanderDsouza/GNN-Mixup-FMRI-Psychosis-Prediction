...
|----------|-------------|
| `GNN.ipynb` | Full architecture workflow: preprocess fMRI data, create spectral embeddings, apply mixup, build patient similarity graph, and train GNN. |
...
| `Including_bprs_baseline_LogisticRegressionMixup.ipynb` | Variant of logistic regression mixup including key demographic features (BPRS baseline). |
